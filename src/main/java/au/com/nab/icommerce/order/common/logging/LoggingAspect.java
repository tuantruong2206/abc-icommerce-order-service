package au.com.nab.icommerce.order.common.logging;

import au.com.nab.icommerce.order.proxy.event.source.AuditActivityPublisher;
...
public class LoggingAspect {
    ...
    @Pointcut("within(au.com.nab.icommerce.order..*)")
    public void inNABIcommerceOrderPackage() {
    }
     ...
     */
    @Around("inNABIcommerceOrderPackage()"
